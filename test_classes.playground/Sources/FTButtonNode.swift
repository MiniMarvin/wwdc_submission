...
public class FTButtonNode: SKSpriteNode {
    ...
    public enum FTButtonActionType: Int {
    ...
    public init(normalTexture defaultTexture: SKTexture!, selectedTexture:SKTexture!, disabledTexture: SKTexture?, width:Float, height:Float) {
    ...
    public init(color: UIColor, width: Float, height: Float) {
     ...
     */
    public func setButtonAction(target: AnyObject, triggerEvent event:FTButtonActionType, action:Selector) {
